...
| `lib/sync/cache-politica.js` | **Última política aceita** (C2a), em `~/.farol/sync-policy.json` com 0600. Não guarda segredo: o modo restrito existe porque este arquivo decide o que o aparelho pode fazer. É o que faz a política sobreviver a reinício, senão reiniciar ampliaria sozinho o que o admin restringiu |
