...
import {
  queueEmptyOkHtml, automacaoPausadaPor, orgsMonitoradas, esc, safeJsonParse, fmtClock, sysNorm, canonicalGithubPrUrl, prKeyFromUrl, repoShort, stripFence,
  sameSet, accountSaveArray,
  fmtRel, aprovadosHoje, avatar, md, feedLine, selfSessionKey,
  ...
  diagnosticsText, PB_SHORT, fmtStamp, fmtWhenDay, resolvedRow,
  logSummaryShort,
