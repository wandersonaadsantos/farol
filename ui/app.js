...
const RELEASE_NOTES = [
  ['2.8.1', ['Instalador BETA pra macOS (Apple Silicon): a release passa a incluir o Farol-Instalar-mac.command, montado sem precisar de um Mac. Ainda não foi validado num Mac de verdade, então é beta: instale, e se algo quebrar, use "Exportar diagnóstico" (aqui em Saúde) e mande. Com esse retorno a gente conserta e libera a versão final. O instalador do macOS também ficou mais robusto (garante o bit de execução do Electron).']],
