...
const RELEASE_NOTES = [
  ['2.54.4', ['A autoanálise dos seus PRs parou de jogar trabalho fora. Ela só existia por clique: quando entrava commit novo o resultado era descartado e ficava esperando você pedir de novo, queimando uma sessão inteira sem entregar nada. Agora a análise que você pediu e que um commit invalidou é refeita sozinha sobre o código atual, com as travas do round de revisão (espera o código parar de mudar, no máximo uma vez por versão do PR, teto diário, conta silenciada e orçamento respeitados). O Farol não passou a analisar PR seu por conta própria: continua sendo só o trabalho que você pediu.']],
