...
As três perguntas são sobre o arquivo como ele fica depois da entrega, e não sobre o trecho que a entrega mudou. Arquivo que já juntava assuntos antes continua juntando, e "esta entrega não piorou" descreve o diff, não o arquivo. Nesse caso o veredito é violação, com o arquivo na frente da evidência e uma avaliação por arquivo em violação; os itens seguintes da evidência são contexto, e um arquivo em violação citado depois do primeiro não conta como violação. Se a dívida não é desta entrega, o lugar dela é o baseline do repositório, com condição de fechamento, e não uma conformidade com a tensão escrita na fundamentação: conformidade não tem contagem nem prazo, e a dívida que só existe na fundamentação cresce entrega após entrega sem virar número (ADR-0015).
