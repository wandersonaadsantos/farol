...
- **Entrega em curso:** nenhuma. Próxima é a T0 (estabilidade da suíte). C1a, C0, A5, A1, A4, C0b, C1, C2a, C2b, C3a a C3g, C4 (código), C5a, C5b, C5c, C5d, C2c, C3h e C4b validadas localmente e **todas integradas** em `md/integracao`.
...
| seguintes | T0 estabilidade da suíte, C6, C7, C8, telas | | planos a escrever | |
...
A C5 e a C4b estão completas. Seguir pela T0 (os treze arquivos de teste com `await` de topo depois de casos registrados, mais uma trava), depois C6 (comandos remotos), C7, C8 e as telas, estas a partir do Claude Design.
