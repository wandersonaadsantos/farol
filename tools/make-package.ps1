...
if ($env:FAROL_ALLOW_DIRTY -ne '1') {
  $dirty = git -C $Src status --porcelain -- main.js server.js package.json lib ui assets workspace-template installer tools/jira-mcp.js tools/farol-parear.js 2>$null
