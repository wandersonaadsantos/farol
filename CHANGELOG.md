...
- **O relançamento retoma a sessão que caiu, em vez de reler o PR do zero.** O Farol guarda a sessão da revisão assim que ela nasce e, quando a queda é transitória, relança pedindo a continuação dela: o que já foi lido e verificado não é pago de novo. Se o PR ganhou commit novo durante a espera, a retomada é descartada e a revisão lê o head atual do zero, porque continuar ali seria pedir pra não reler justamente o que mudou. Isso vale para as sessões do Claude; sessão do Codex não tem retomada e relança do zero (o teto de 3 tentativas continua valendo nos dois casos).
- **Relançamento retoma a sessão interrompida com `--resume`** (o que já foi lido e verificado não é pago de novo); sem sessão recuperável, recomeça do zero como antes.
