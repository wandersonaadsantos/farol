...
Regras aprendidas com reviews reais (retro de 14/07/2026, estudo em `docs/reviews-retro-2026-07.md` na fonte do app, mais pushbacks confirmados de autores que tinham razão). Os itens 1 a 7 são nuances da org biudtech; 8 a 11 valem em qualquer repo. Calibram severidade e tom; não afrouxam o gate de blocker.
