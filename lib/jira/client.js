...
function createJiraClient({ baseUrl, email, token, fetchImpl }) {
  ...
  return {
    ...
    // identidade da própria credencial: é o teste mais barato de "isto funciona",
    // porque não depende de existir card nenhum nem de permissão em projeto.
    myself: () => pedir(JIRA.MYSELF_PATH),
