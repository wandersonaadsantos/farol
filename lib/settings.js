...
const SETTINGS = [
  ...
  { key: 'sync', def: { enabled: false, coordination: { enabled: false }, consolidation: { enabled: false }, shared: { enabled: false }, aceitarAdmin: false, deviceName: '', apiKey: '', databaseUrl: '', projectId: '' }, ui: true, san: (v, c, f) => f.parseSyncConfig(v, c.sync) },
