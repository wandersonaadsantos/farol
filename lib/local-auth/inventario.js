...
const CLASSES = Object.freeze({
  'leitura-sensivel': ['/api/state', '/api/chat', '/api/decision', '/api/highlights', '/api/team', '/api/log', '/api/log/triage', '/api/diagnostics', '/api/doctor', '/api/sync/consolidated', '/api/sync/reviews', '/api/sync/lists', '/api/sync/review-body', '/api/sync/command-status', '/api/sync/takeover-notice', '/api/auth/sessions'],
