...
const CLASSES = Object.freeze({
  ...
  'demais': ['/api/check', '/api/jira/credential/remove', '/api/jira/test', '/api/sync/logout', '/api/sync/test', '/api/sync/redo', '/api/sync/consolidate', '/api/sync/group', '/api/sync/command', '/api/sync/policy', '/api/sync/link', '/api/sync/device', '/api/sync/seen', '/api/sync/history-measure', '/api/sync/history-send', '/api/claude-login', '/api/self-review/visibility', '/api/self-review/cancel', '/api/pr/hide', '/api/pr/unhide', '/api/ignore', '/api/restore', '/api/settings', '/api/pushback', '/api/tool/clear', '/api/cancel', '/api/session-exit', '/api/update', '/api/chat/stop'],
