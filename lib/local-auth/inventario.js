...
const CLASSES = Object.freeze({
  'leitura-sensivel': ['/api/state', '/api/chat', '/api/chat/export', '/api/decision', '/api/highlights', '/api/team', '/api/log', '/api/log/triage', '/api/diagnostics', '/api/doctor', '/api/sync/consolidated', '/api/sync/reviews', '/api/sync/review-body', '/api/sync/command-status', '/api/sync/takeover-notice', '/api/auth/sessions', '/api/sync/policy-read', '/api/sync/transfer-targets', '/api/sync/lists'],
  ...
  'demais': ['/api/check', '/api/jira/credential/remove', '/api/jira/test', '/api/sync/logout', '/api/sync/test', '/api/sync/redo', '/api/sync/consolidate', '/api/sync/group', '/api/sync/command', '/api/sync/policy', '/api/sync/designation-decline', '/api/sync/link', '/api/sync/device', '/api/sync/seen', '/api/sync/history-measure', '/api/sync/history-send', '/api/claude-login', '/api/claude/profile-test', '/api/claude/profile-adopt', '/api/self-review/visibility', '/api/self-review/cancel', '/api/pr/hide', '/api/pr/unhide', '/api/ignore', '/api/restore', '/api/settings', '/api/accounts/edit', '/api/pushback', '/api/tool/clear', '/api/cancel', '/api/session-exit', '/api/update', '/api/chat/stop'],
