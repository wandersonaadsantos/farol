...
// O que o Auto usa quando o CONTEXTO do PR pede mais que o tamanho (25/09/2026): repositorio
// critico, caminho sensivel ou PR muito grande (lib/engine/model-router.js decide qual vale).
// Esforco medio por decisao do dono: o Opus ja e o salto de capacidade, e o medio segura o
// custo, que e o objetivo do Auto. Sem modo rapido: rapido e o oposto do que o gatilho pede.
const AUTO_POR_CONTEXTO = Object.freeze({ selecao: 'opus', effort: 'medium', fast: false });
...
// "Auto (custo-benefício: Opus/Sonnet/Haiku pelo contexto e o tamanho do PR)": os nomes saem
// do contexto e das faixas, entao o rotulo nunca promete um modelo que o Auto deixou de usar.
function rotuloDoAuto() {
  ...
  return `Auto (custo-benefício: ${nomes.join('/')} pelo contexto e o tamanho do PR)`;
}
