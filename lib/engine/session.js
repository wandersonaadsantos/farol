...
import { sanitizeModel, sanitizeEffort, effortForModel, claudeAuthShellLines, claudeAuthPosixPrefix, applyClaudeAuthEnv } from '../parse.js';
...
function buildModelFlags(config, opts = {}) {
  ...
  let effort = sanitizeEffort(cfg.reviewEffort) || '';
