...
const TEXT_RULES = [
  ...
  // no texto de review: "Farol vX.Y.Z" denuncia a proveniência tão bem quanto
  // "gerado pelo Farol", mas escapava do STRONG_REVIEW_ACTOR porque não tem
  // verbo de ação nem objeto de review na frase (ver contextualLanguageIssues).
  ['tool_version', /\bfarol\b[^.\r\n]{0,30}\bv?\d{1,4}\.\d{1,4}\.\d{1,4}\b/],
  ['tool_version', /\bv?\d{1,4}\.\d{1,4}\.\d{1,4}\b[^.\r\n]{0,30}\bfarol\b/],
];
