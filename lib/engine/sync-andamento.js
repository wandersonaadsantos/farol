...
// distribuição e o PR de cada sessão viva (é o que nomeia a operação no andamento dos
// outros, mesmo quando ela saiu de um clique fora da fila). Panorama e Meus PRs já viajam
// nos escopos, com o próprio texto.
//
// UM PR, UMA LINHA: a sessão guarda só parte dos campos, e a mesma chave vinda de duas
// fontes com linhas diferentes seria reescrita a cada giro. A primeira fonte vence.
function prsDoCatalogo(engine) {
  ...
  return [...fila, ...distribuindo, ...vivas].filter((pr) => {
