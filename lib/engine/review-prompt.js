...
function headlessPromptFor(engine, url, author, lotes, metrics) {
  ...
  for (const f of candidates) {
    try {
      ...
      return base
        + engine.personProfileBlock(author) + licoesDesteRepo(engine, pr, author)
...
export default { personProfileBlock, reviewFormatBlock, thirdPartyReviewBlock, licoesDesteRepo, headlessPromptFor };
export { personProfileBlock, reviewFormatBlock, thirdPartyReviewBlock, licoesDesteRepo, headlessPromptFor };
