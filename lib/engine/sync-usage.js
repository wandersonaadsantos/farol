...
import { readOutbox, saveOutbox, enqueueSession, reconcileFromSessions, reconcileCorrections, flushOutbox, resetForFullSync, outboxTarget, retargetOutbox } from '../sync/outbox.js';
...
function outboxReconciliada(engine) {
  ...
  // correção de desfecho anterior ao cursor (A1, item 7): a linha carimbada volta à fila
