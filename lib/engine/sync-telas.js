...
async function emitirComando(engine, dados) {
  ...
  rt.comandosEmitidos.unshift({ cmdId: r.cmdId, tipo: String(dados && dados.tipo || ''), alvo: String(dados && dados.alvo || ''), at: Date.now() });
...
export default { projecaoDasTelas, adminParaTela, distribuicaoParaTela, admissaoParaTela, emitidosParaTela, emitirComando, desfechoDoComando, avisoDaTomada, estadoDaLimpeza };
export { projecaoDasTelas, adminParaTela, distribuicaoParaTela, admissaoParaTela, emitidosParaTela, emitirComando, desfechoDoComando, avisoDaTomada, estadoDaLimpeza };
