...
function esperandoParaTela(rt, x) {
  ...
  return {
    ...
    // quem o distribuidor escolheu, e o motivo de cada publicador que ficou de fora: os
    // dois saem do que o conjunto publicou, e vazio segue sendo "não se sabe daqui"
    dev: String(registro.dev || ''),
