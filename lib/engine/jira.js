...
function escreverConfig(site) {
  ...
  // o node. ELECTRON_RUN_AS_NODE=1 seleciona o modo Node de servidor. Sem a
  // variável ele inicia como browser; dependendo do SO pode até responder ao
  // MCP nesse modo, mas isso não comprova a execução como Node exigida aqui.
