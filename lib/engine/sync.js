...
function novoRuntime() {
  const rt = {
    ...
    material: null, chaveVista: false, chaveMotivo: '',
  };
...
export default {
  ...
  touchPresence, syncLogin, syncLogout, syncTest, syncUnlock, syncGerarChaveNova, syncTornarAdmin, statusForUi, seguraAutomacao, registrarEspera,
