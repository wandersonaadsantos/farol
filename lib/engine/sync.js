...
async function iniciar(engine) {
  ...
  // só era ligado no tique de polling seguinte, e a tela passava minutos sem dizer quem é o admin
  if (sharedActive(cfg)) syncAndamento.ligarRelogio(engine, cfgDe);
