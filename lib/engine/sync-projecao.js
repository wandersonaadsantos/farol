...
// `contract` e `keyReady` são o que o gate da frota (lib/sync/frota.js) consulta para
// decidir se vale publicar. Sem eles aqui, nenhum aparelho lido do banco parecia pronto, e
// catálogo e capacidade nunca subiam fora dos testes. Os tipos continuam estritos: número
// inteiro e `true` explícito, senão vira 0 e `false`.
function projecaoDoAparelho(d) {
  const o = d && typeof d === 'object' ? d : {};
  return {
    name: texto(o.name), platform: texto(o.platform), farolVersion: texto(o.farolVersion),
    lastSeenAt: Number(o.lastSeenAt) || 0, retiredAt: Number(o.retiredAt) || 0,
    contract: Number.isInteger(o.contract) ? o.contract : 0, keyReady: o.keyReady === true,
  };
}
