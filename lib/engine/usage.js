...
// tokens, costUsd) + label. Perfil removido do config ainda aparece (histórico
// preservado, mesma filosofia de byAccount com conta removida), com o id cru como label.
