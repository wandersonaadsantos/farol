...
async function launchReReviews(engine) {
  ...
  for (const pr of alvos) {
    /* Gate de consciência do review automático (28/08/2026 à tarde), ANTES até
       ...
       Re-revisar continua valendo). A âncora já gravada acima é desejada aqui:
       o caminho automático não fica reconsultando o mesmo head a cada ciclo. */
    if (await engine.bloqueiaAutomatico(pr)) continue;
...
const reviewMod = {
  ...
  inProgressLabelFor, addInProgressLabel, removeInProgressLabel,
