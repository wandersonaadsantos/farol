...
const ghQueries = { searchPRs, myAuthoredPRs, deliveriesSince, fetchDeliveries, prState, headSha, refreshContributors };
export default ghQueries;
export { searchPRs, myAuthoredPRs, deliveriesSince, fetchDeliveries, prState, headSha, refreshContributors };
