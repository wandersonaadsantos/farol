...
async function searchPRs(engine, extraArgs, user) {
  ...
  // (lib/engine/skip-review.js). Vem da MESMA chamada, sem custo de rede extra;
  // só o nome de cada label entra no objeto, porque cor/id/descrição não decidem
  // nada e o objeto do PR vai cru pro snapshot da UI a cada push.
