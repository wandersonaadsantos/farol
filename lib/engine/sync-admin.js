...
async function syncTornarAdmin(engine, cfg, fetchImpl, { password } = {}) {
  ...
  // o toast diz "agora é o admin": a tela não pode esperar o próximo giro do relógio para
  // concordar. Só QUEM é o admin; frescor continua saindo do batimento observado.
  sinais.anotarAdmin(rt, { dev: rt.deviceId, generation });
