...
async function postReview(engine, pr, payload) {
  ...
  const minha = anterior.then(() => postReviewSerial(engine, pr, payload, lane),
    () => postReviewSerial(engine, pr, payload, lane));
...
async function postReviewSerial(engine, pr, payload, lane) {
  ...
  const r = await postReviewOnce(engine, pr, payload);
...
async function postReviewOnce(engine, pr, payload) {
  let file = null;
  let attempted = false;
  try {
