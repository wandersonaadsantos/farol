...
function retirarConsentimento(engine, cfg) {
  ...
  const apagou = cachePolitica.apagarPolitica();
  if (typeof engine.pushState === 'function') engine.pushState();
...
export default { syncRevogar, retirarConsentimento, resumoDaRevogacao, authTimeDe };
export { syncRevogar, retirarConsentimento, resumoDaRevogacao, authTimeDe };
