...
function escolher(itens, aparelhos, ctx = {}) {
  ...
  for (const item of fila) {
    ...
    if (!onde.dev) { semAparelho.push({ itemId: item.itemId, motivo: onde.motivo }); continue; }
...
export default { escolher, escolherOnde, aparelhosPara };
export { escolher, escolherOnde, aparelhosPara };
