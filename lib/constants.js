...
const SYNC = {
  ...
  // limpeza protegida (7.C2): a trava cooperativa do ato vence em 10 minutos. Ela existe
  // para os outros aparelhos recusarem admissão nova enquanto a limpeza corre, e o
  // vencimento é o que impede um ato interrompido de travar o conjunto para sempre.
  LIMPEZA_TRAVA_MS: 10 * 60 * 1000,
