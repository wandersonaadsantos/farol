...
const CLASSES = [
  ...
  },
  {
    ...
    // estoura o tempo.
    // Ressalva: esta mesma mensagem sai também do teto do lib/codex/stream.js, e o
    // Codex não tem `--resume`. Sessão de Codex que estoura o tempo relança do zero
    // (o teto de 3 tentativas continua valendo); só a sessão de Claude retoma.
    id: 'tempo-esgotado',
