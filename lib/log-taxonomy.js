...
const CLASSES = [
  ...
  },
  {
    ...
    re: /ECONNRESET|ENOTFOUND|ETIMEDOUT|Connection closed|Unable to connect|fetch failed|network|error connecting to api\.github\.com|buscas gh falharam|dial tcp|connectex|TLS handshake timeout/i,
  },
  {
