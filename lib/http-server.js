...
function syncRevisoesDe(lista) { return Array.isArray(lista) ? { ok: true, revisoes: lista } : syncFalha({ code: 'indisponivel', motivo: 'não deu para ler as revisões dos aparelhos agora' }); }
