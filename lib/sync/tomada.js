...
const RISCO_NO_TEXTO = { provavel: 'duplicidade provável', possivel: 'duplicidade possível' };
...
function avisoDaTomada(atual, { nowMs, nomeDoAparelho = '' }) {
  ...
  return [
    ...
    `O que pode acontecer é a análise rodar duas vezes e custar duas vezes (${RISCO_NO_TEXTO[risco]}).`,
  ].join(' ');
}
