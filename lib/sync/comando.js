...
const ESQUEMA = 'cmd1';
const TIPOS = ['cancelar', 'repetir', 'decidir', 'iniciar', 'transferir', 'designar-admin'];
...
const ARGUMENTOS = {
  cancelar: cancelarDe, repetir: repetirDe, decidir: decidirDe, iniciar: iniciarDe, transferir: transferirDe, 'designar-admin': () => ({}),
};
