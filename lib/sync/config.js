...
export default { syncDefaults, parseSyncConfig, coordinationActive, consolidationActive, sharedActive, databaseUrlProblema, authUrlsFor };
export { syncDefaults, parseSyncConfig, coordinationActive, consolidationActive, sharedActive, databaseUrlProblema, authUrlsFor };
