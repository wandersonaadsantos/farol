...
export default { syncDefaults, parseSyncConfig, coordinationActive, consolidationActive, sharedActive, distributionActive, databaseUrlProblema, authUrlsFor };
export { syncDefaults, parseSyncConfig, coordinationActive, consolidationActive, sharedActive, distributionActive, databaseUrlProblema, authUrlsFor };
