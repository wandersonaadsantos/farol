...
// Conteúdo sincronizado que existe hoje. Entrega que publicar conteúdo novo (C3 em diante)
// acrescenta o nó dela AQUI, junto com o teste, senão ele simplesmente não é apagável.
const CATEGORIAS = ['live/deviceStatus', 'live/devicePolicies', 'live/groups', 'usageEvents'];
